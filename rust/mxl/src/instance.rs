...
use crate::{
    Error, FlowConfigInfo, FlowReader, FlowWriter, Result,
    api::MxlApiHandle,
    fabrics::{self, FabricsInstance},
};
...
impl MxlInstance {
    ...
    pub fn create_fabrics_instance(&self) -> Result<FabricsInstance> {
        fabrics::create_instance(&self.context)
    }
}
