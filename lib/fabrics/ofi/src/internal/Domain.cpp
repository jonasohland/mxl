...
namespace mxl::lib::fabrics::ofi
{
    ...
    std::shared_ptr<Domain> Domain::open(std::shared_ptr<Fabric> fabric)
    {
        ...
        {
            MakeSharedEnabler(::fid_domain* domain, std::shared_ptr<Fabric> fabric, std::vector<RegisteredRegion> registerRegion)
                : Domain(domain, std::move(fabric), std::move(registerRegion))
            {}
        };
